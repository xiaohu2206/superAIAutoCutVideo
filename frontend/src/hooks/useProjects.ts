...
export const useProjectDetail = (
  ...
  const extractScenes = useCallback(async (options?: { force?: boolean; task_id?: string | null; asr_provider?: "bcut" | "fun_asr"; asr_model_key?: string | null; asr_language?: string | null; itn?: boolean; hotwords?: string[]; analyzeVision?: boolean; visionMode?: string; visionKeyFrames?: 1 | 3 }) => {
    if (!project) return;
    setError(null);
